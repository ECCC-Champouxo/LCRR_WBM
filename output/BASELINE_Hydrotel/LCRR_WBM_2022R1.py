# -*- coding: UTF-8 -*-
####################################################################
__author__ = 'Section Hydrodynamique et Ecohydraulique--Olivier Champoux@ec.gc.ca'
__version__ = '2022R1'
__date__ = '2022-03-18'
__update__ = ''
__copyright__ = 'Copyright (c) 2022 Environment Canada'
# *****************************************************************************



import os,sys,time,getopt,shutil,math
import numpy as np
import pandas as pd
...
################################# condition to test with or without diversion #####################################
            ...
            #### High flow correction with daily friction ####
