...
class WBM_PLOTTER(object):
    ...
    _parser=None
    _graphs_folder=(os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..', 'output','graphs','NBS_CORDEX','current')))
    _xls_outputs=(os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..', 'output','Excel_files','NBS_CORDEX','current')))
